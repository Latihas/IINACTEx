...
public static class NotActMainFormatter {
	public static void SetupEnvironment() {
		...
		EncounterData.ColumnDefs.Add("EncDPS",
		...
		EncounterData.ColumnDefs.Add("Zone",
			new EncounterData.ColumnDef("Zone", false, "VARCHAR(64)", "Zone",
				Data => Data.ZoneName,
				Data => Data.ZoneName));
		EncounterData.ColumnDefs.Add("Kills",
		...
		EncounterData.ExportVariables.Add("t",
			new EncounterData.TextExportFormatter("t", "Tab Character",
				...
				(_, _, _) => "\t"));
		EncounterData.ExportVariables.Add("title",
			new EncounterData.TextExportFormatter("title", "Encounter Title",
				...
				(Data, SelectiveAllies, Extra) =>
					EncounterFormatSwitch(Data, SelectiveAllies, "title", Extra)));
		EncounterData.ExportVariables.Add("duration",
			new EncounterData.TextExportFormatter("duration", "Duration",
				...
				(Data, SelectiveAllies, Extra) =>
					EncounterFormatSwitch(Data, SelectiveAllies, "duration", Extra)));
		EncounterData.ExportVariables.Add("DURATION",
			new EncounterData.TextExportFormatter("DURATION", "Short Duration",
				...
				(Data, SelectiveAllies, Extra) =>
					EncounterFormatSwitch(Data, SelectiveAllies, "DURATION", Extra)));
		EncounterData.ExportVariables.Add("damage",
		...
		EncounterData.ExportVariables.Add("encdps",
			new EncounterData.TextExportFormatter("encdps", "Encounter DPS",
				...
				(Data, SelectiveAllies, Extra) =>
					EncounterFormatSwitch(Data, SelectiveAllies, "encdps", Extra)));
		EncounterData.ExportVariables.Add("encdps-*",
		...
		EncounterData.ExportVariables.Add("ENCDPS-*",
			new EncounterData.TextExportFormatter("ENCDPS-*", "Short Encounter DPS w/suffix",
				...
				(Data, SelectiveAllies, Extra) =>
					EncounterFormatSwitch(Data, SelectiveAllies, "ENCDPS-*", Extra)));
		EncounterData.ExportVariables.Add("hits",
		...
		EncounterData.ExportVariables.Add("crithit%",
			new EncounterData.TextExportFormatter("crithit%", "Critical Hit Percentage",
				...
				(Data, SelectiveAllies, Extra) =>
					EncounterFormatSwitch(Data, SelectiveAllies, "crithit%", Extra)));
		EncounterData.ExportVariables.Add("misses",
			new EncounterData.TextExportFormatter("misses", "Misses",
				"The number of auto-attacks or CAs that produced a miss message.",
				(Data, SelectiveAllies, Extra) =>
					EncounterFormatSwitch(Data, SelectiveAllies, "misses", Extra)));
		EncounterData.ExportVariables.Add("hitfailed",
			new EncounterData.TextExportFormatter(
				...
				(Data, SelectiveAllies, Extra) =>
					EncounterFormatSwitch(Data, SelectiveAllies, "hitfailed", Extra)));
		EncounterData.ExportVariables.Add("swings",
			new EncounterData.TextExportFormatter("swings", "Swings (Attacks)",
				...
				(Data, SelectiveAllies, Extra) =>
					EncounterFormatSwitch(Data, SelectiveAllies, "swings", Extra)));
		EncounterData.ExportVariables.Add("tohit",
			new EncounterData.TextExportFormatter("tohit", "To Hit %", "The percentage of hits to swings as 12.34",
				(Data, SelectiveAllies, Extra) =>
					EncounterFormatSwitch(Data, SelectiveAllies, "tohit", Extra)));
		EncounterData.ExportVariables.Add("TOHIT",
			new EncounterData.TextExportFormatter("TOHIT", "Short To Hit %",
				"The percentage of hits to swings as 12",
				(Data, SelectiveAllies, Extra) =>
					EncounterFormatSwitch(Data, SelectiveAllies, "TOHIT", Extra)));
		EncounterData.ExportVariables.Add("maxhit",
			new EncounterData.TextExportFormatter("maxhit", "Highest Hit",
				...
				(Data, SelectiveAllies, Extra) =>
					EncounterFormatSwitch(Data, SelectiveAllies, "maxhit", Extra)));
		EncounterData.ExportVariables.Add("MAXHIT",
		...
		EncounterData.ExportVariables.Add("MAXHIT-*",
			new EncounterData.TextExportFormatter("MAXHIT-*", "Short Highest Hit w/ suffix",
				...
				(Data, SelectiveAllies, Extra) =>
					EncounterFormatSwitch(Data, SelectiveAllies, "MAXHIT-*", Extra)));
		EncounterData.ExportVariables.Add("healed",
			new EncounterData.TextExportFormatter("healed", "Healed",
				...
				(Data, SelectiveAllies, Extra) =>
					EncounterFormatSwitch(Data, SelectiveAllies, "healed", Extra)));
		EncounterData.ExportVariables.Add("enchps",
			new EncounterData.TextExportFormatter("enchps", "Encounter HPS",
				...
				(Data, SelectiveAllies, Extra) =>
					EncounterFormatSwitch(Data, SelectiveAllies, "enchps", Extra)));
		EncounterData.ExportVariables.Add("enchps-*",
		...
		EncounterData.ExportVariables.Add("cures",
			new EncounterData.TextExportFormatter("cures", "Cure or Dispel Count",
				...
				(Data, SelectiveAllies, Extra) =>
					EncounterFormatSwitch(Data, SelectiveAllies, "cures", Extra)));
		EncounterData.ExportVariables.Add("maxheal",
			new EncounterData.TextExportFormatter("maxheal", "Highest Heal",
				...
				(Data, SelectiveAllies, Extra) =>
					EncounterFormatSwitch(Data, SelectiveAllies, "maxheal", Extra)));
		EncounterData.ExportVariables.Add("MAXHEAL",
		...
		EncounterData.ExportVariables.Add("maxhealward",
			new EncounterData.TextExportFormatter(
				...
				(Data, SelectiveAllies, Extra) =>
					EncounterFormatSwitch(Data, SelectiveAllies, "maxhealward", Extra)));
		EncounterData.ExportVariables.Add("MAXHEALWARD",
			new EncounterData.TextExportFormatter(
		...
		EncounterData.ExportVariables.Add("damagetaken",
			new EncounterData.TextExportFormatter(
				...
				(Data, SelectiveAllies, Extra) =>
					EncounterFormatSwitch(Data, SelectiveAllies, "damagetaken", Extra)));
		EncounterData.ExportVariables.Add("damagetaken-*",
			new EncounterData.TextExportFormatter(
		...
		EncounterData.ExportVariables.Add("healstaken",
			new EncounterData.TextExportFormatter(
				...
				(Data, SelectiveAllies, Extra) =>
					EncounterFormatSwitch(Data, SelectiveAllies, "healstaken", Extra)));
		EncounterData.ExportVariables.Add("healstaken-*",
			new EncounterData.TextExportFormatter(
		...
		EncounterData.ExportVariables.Add("powerdrain",
			new EncounterData.TextExportFormatter(
				...
				(Data, SelectiveAllies, Extra) =>
					EncounterFormatSwitch(Data, SelectiveAllies, "powerdrain", Extra)));
		EncounterData.ExportVariables.Add("powerdrain-*",
			new EncounterData.TextExportFormatter(
		...
		EncounterData.ExportVariables.Add("powerheal",
			new EncounterData.TextExportFormatter(
				...
				(Data, SelectiveAllies, Extra) =>
					EncounterFormatSwitch(Data, SelectiveAllies, "powerheal", Extra)));
		EncounterData.ExportVariables.Add("powerheal-*",
			new EncounterData.TextExportFormatter(
				...
				(Data, SelectiveAllies, Extra) =>
					EncounterFormatSwitch(Data, SelectiveAllies, "powerheal-*", Extra)));
		EncounterData.ExportVariables.Add("kills",
			new EncounterData.TextExportFormatter("kills", "Killing Blows",
				"The total number of times this character landed a killing blow.",
				(Data, SelectiveAllies, Extra) =>
					EncounterFormatSwitch(Data, SelectiveAllies, "kills", Extra)));
		EncounterData.ExportVariables.Add("deaths",
			new EncounterData.TextExportFormatter("deaths", "Deaths",
				"The total number of times this character was killed by another.",
				(Data, SelectiveAllies, Extra) =>
					EncounterFormatSwitch(Data, SelectiveAllies, "deaths", Extra)));
		CombatantData.ColumnDefs.Clear();
		CombatantData.ColumnDefs.Add("EncId",
			new CombatantData.ColumnDef("EncId", false, "CHAR(8)", "EncId",
				_ => string.Empty, Data => Data.Parent.EncId, (_, _) => 0));
		CombatantData.ColumnDefs.Add("Ally",
			new CombatantData.ColumnDef("Ally", false, "CHAR(1)", "Ally",
				Data => Data.Parent.GetAllies().Contains(Data).ToString(),
				Data => !Data.Parent.GetAllies().Contains(Data) ? "F" : "T",
				(Left, Right) =>
					Left.Parent.GetAllies().Contains(Left).CompareTo(Right.Parent.GetAllies().Contains(Right))));
		...
		CombatantData.ColumnDefs.Add("StartTime",
			new CombatantData.ColumnDef("StartTime", true, "TIMESTAMP", "StartTime",
				Data => !(Data.StartTime == DateTime.MaxValue)
		...
		CombatantData.ColumnDefs.Add("EndTime",
		...
		CombatantData.ColumnDefs.Add("Damage%",
			new CombatantData.ColumnDef("Damage%", true, "VARCHAR(4)", "DamagePerc",
				...
				Data => Data.DamagePercent,
				(Left, Right) => Left.Damage.CompareTo(Right.Damage)));
		CombatantData.ColumnDefs.Add("Kills",
		...
		CombatantData.ColumnDefs.Add("Healed",
		...
		CombatantData.ColumnDefs.Add("CritHeals",
			new CombatantData.ColumnDef("CritHeals", false, "INT", "CritHeals",
				Data => Data.CritHeals.ToString((string?)GetIntCommas()),
				Data => Data.CritHeals.ToString(),
				(Left, Right) => Left.CritHeals.CompareTo(Right.CritHeals)));
		CombatantData.ColumnDefs.Add("Heals",
		...
		CombatantData.ColumnDefs.Add("Cures",
		...
		CombatantData.ColumnDefs.Add("EncDPS",
			new CombatantData.ColumnDef("EncDPS", true, "DOUBLE", "EncDPS",
				...
				(Left, Right) => Left.Damage.CompareTo(Right.Damage)));
		CombatantData.ColumnDefs.Add("EncHPS",
			new CombatantData.ColumnDef("EncHPS", true, "DOUBLE", "EncHPS",
				...
				(Left, Right) => Left.Healed.CompareTo(Right.Healed)));
		CombatantData.ColumnDefs.Add("Hits",
		...
		CombatantData.ColumnDefs.Add("CritHits",
		...
		CombatantData.ColumnDefs.Add("Avoids",
		...
		CombatantData.ColumnDefs.Add("Misses",
		...
		CombatantData.ColumnDefs.Add("Swings",
		...
		CombatantData.ColumnDefs.Add("HealingTaken",
			new CombatantData.ColumnDef("HealingTaken", false, "BIGINT", "HealsTaken",
				Data => Data.HealsTaken.ToString((string?)GetIntCommas()),
		...
		CombatantData.ColumnDefs.Add("DamageTaken",
			new CombatantData.ColumnDef("DamageTaken", true, "BIGINT", "DamageTaken",
				Data => Data.DamageTaken.ToString((string?)GetIntCommas()),
				Data => Data.DamageTaken.ToString(),
				(Left, Right) => Left.DamageTaken.CompareTo(Right.DamageTaken)));
		CombatantData.ColumnDefs.Add("Deaths",
		...
		CombatantData.ColumnDefs.Add("ToHit%",
		...
		CombatantData.ColumnDefs.Add("CritDam%",
			new CombatantData.ColumnDef("CritDam%", false, "VARCHAR(8)", "CritDamPerc",
				Data => Data.CritDamPerc.ToString("0'%"),
				Data => Data.CritDamPerc.ToString("0'%"),
				(Left, Right) => Left.CritDamPerc.CompareTo(Right.CritDamPerc)));
		CombatantData.ColumnDefs.Add("CritHeal%",
			new CombatantData.ColumnDef("CritHeal%", false, "VARCHAR(8)", "CritHealPerc",
		...
		CombatantData.ColumnDefs.Add("CritTypes",
			new CombatantData.ColumnDef("CritTypes", true, "VARCHAR(32)", "CritTypes",
				CombatantDataGetCriticalTypes,
				CombatantDataGetCriticalTypes,
				(Left, Right) => CombatantDataGetCriticalTypes(Left).CompareTo(CombatantDataGetCriticalTypes(Right))));
		CombatantData.ColumnDefs.Add("Threat +/-",
			new CombatantData.ColumnDef("Threat +/-", false, "VARCHAR(32)", "ThreatStr",
				Data => Data.GetThreatStr("Threat (Out)"),
				Data => Data.GetThreatStr("Threat (Out)"),
				(Left, Right) =>
					Left.GetThreatDelta("Threat (Out)").CompareTo(Right.GetThreatDelta("Threat (Out)"))));
		CombatantData.ColumnDefs.Add("ThreatDelta",
			new CombatantData.ColumnDef("ThreatDelta", false, "BIGINT", "ThreatDelta",
				Data => Data.GetThreatDelta("Threat (Out)").ToString((string?)GetIntCommas()),
				Data => Data.GetThreatDelta("Threat (Out)").ToString(),
				(Left, Right) =>
					Left.GetThreatDelta("Threat (Out)").CompareTo(Right.GetThreatDelta("Threat (Out)"))));
		...
		CombatantData.ExportVariables.Add("damage%",
			new CombatantData.TextExportFormatter("damage%", "Damage %",
				...
				(Data, Extra) => CombatantFormatSwitch(Data, "damage%", Extra)));
		CombatantData.ExportVariables.Add("dps",
			new CombatantData.TextExportFormatter("dps", "DPS",
				"The damage total of the combatant divided by their personal duration, formatted as 12.34",
				(Data, Extra) => CombatantFormatSwitch(Data, "dps", Extra)));
		CombatantData.ExportVariables.Add("dps-*",
		...
		CombatantData.ExportVariables.Add("ENCDPS",
			new CombatantData.TextExportFormatter("ENCDPS", "Short Encounter DPS",
				"The damage total of the combatant divided by the duration of the encounter, formatted as 12 -- This is more commonly used than DPS",
				(Data, Extra) => CombatantFormatSwitch(Data, "ENCDPS", Extra)));
		CombatantData.ExportVariables.Add("ENCDPS-k",
			new CombatantData.TextExportFormatter("ENCDPS-k", "Short Encounter DPS K",
				...
				(Data, Extra) => CombatantFormatSwitch(Data, "ENCDPS-k", Extra)));
		CombatantData.ExportVariables.Add("ENCDPS-m",
			new CombatantData.TextExportFormatter("ENCDPS-m", "Short Encounter DPS M",
				...
				(Data, Extra) => CombatantFormatSwitch(Data, "ENCDPS-m", Extra)));
		CombatantData.ExportVariables.Add("ENCDPS-*",
			new CombatantData.TextExportFormatter("ENCDPS-*", "Short Encounter DPS w/suffix",
				...
				(Data, Extra) => CombatantFormatSwitch(Data, "ENCDPS-*", Extra)));
		CombatantData.ExportVariables.Add("hits",
			new CombatantData.TextExportFormatter("hits", "Hits",
				"The number of attack attempts that produced damage.  IE a spell successfully doing damage.",
				(Data, Extra) => CombatantFormatSwitch(Data, "hits", Extra)));
		CombatantData.ExportVariables.Add("crithits",
			new CombatantData.TextExportFormatter("crithits", "Critical Hit Count",
				"The number of damaging attacks that were critical.",
				(Data, Extra) => CombatantFormatSwitch(Data, "crithits", Extra)));
		CombatantData.ExportVariables.Add("crithit%",
			new CombatantData.TextExportFormatter("crithit%", "Critical Hit Percentage",
				"The percentage of damaging attacks that were critical.",
				(Data, Extra) => CombatantFormatSwitch(Data, "crithit%", Extra)));
		CombatantData.ExportVariables.Add("crittypes",
			new CombatantData.TextExportFormatter(
				...
				(Data, Extra) => CombatantFormatSwitch(Data, "crittypes", Extra)));
		CombatantData.ExportVariables.Add("misses",
			new CombatantData.TextExportFormatter("misses", "Misses",
				"The number of auto-attacks or CAs that produced a miss message.",
				(Data, Extra) => CombatantFormatSwitch(Data, "misses", Extra)));
		CombatantData.ExportVariables.Add("hitfailed",
			new CombatantData.TextExportFormatter(
				"hitfailed", "Other Avoid",
				"Any type of failed attack that was not a miss.  This includes resists, reflects, blocks, dodging, etc.",
				(Data, Extra) => CombatantFormatSwitch(Data, "hitfailed", Extra)));
		CombatantData.ExportVariables.Add("swings",
			new CombatantData.TextExportFormatter("swings", "Swings (Attacks)",
				"The number of attack attempts.  This includes any auto-attacks or abilities, also including resisted abilities that do no damage.",
				(Data, Extra) => CombatantFormatSwitch(Data, "swings", Extra)));
		CombatantData.ExportVariables.Add("tohit",
			new CombatantData.TextExportFormatter("tohit", "To Hit %", "The percentage of hits to swings as 12.34",
				(Data, Extra) => CombatantFormatSwitch(Data, "tohit", Extra)));
		CombatantData.ExportVariables.Add("TOHIT",
			new CombatantData.TextExportFormatter("TOHIT", "Short To Hit %",
				"The percentage of hits to swings as 12",
				(Data, Extra) => CombatantFormatSwitch(Data, "TOHIT", Extra)));
		CombatantData.ExportVariables.Add("maxhit",
			new CombatantData.TextExportFormatter("maxhit", "Highest Hit",
				"The highest single damaging hit formatted as [Combatant-]SkillName-Damage#",
				(Data, Extra) => CombatantFormatSwitch(Data, "maxhit", Extra)));
		CombatantData.ExportVariables.Add("MAXHIT",
		...
		CombatantData.ExportVariables.Add("ENCHPS",
			new CombatantData.TextExportFormatter("ENCHPS", "Short Encounter HPS",
				"The healing total of the combatant divided by the duration of the encounter, formatted as 12",
				(Data, Extra) => CombatantFormatSwitch(Data, "ENCHPS", Extra)));
		CombatantData.ExportVariables.Add("ENCHPS-k",
			new CombatantData.TextExportFormatter("ENCHPS-k", "Short Encounter HPS K",
				...
				(Data, Extra) => CombatantFormatSwitch(Data, "ENCHPS-k", Extra)));
		CombatantData.ExportVariables.Add("ENCHPS-m",
			new CombatantData.TextExportFormatter("ENCHPS-m", "Short Encounter HPS M",
				...
				(Data, Extra) => CombatantFormatSwitch(Data, "ENCHPS-m", Extra)));
		CombatantData.ExportVariables.Add("ENCHPS-*",
		...
		CombatantData.ExportVariables.Add("critheals",
			new CombatantData.TextExportFormatter(
				"critheals", "Critical Heal Count",
				"The number of heals that were critical.",
				(Data, Extra) => CombatantFormatSwitch(Data, "critheals", Extra)));
		CombatantData.ExportVariables.Add("critheal%",
			new CombatantData.TextExportFormatter(
				"critheal%", "Critical Heal Percentage",
				"The percentage of heals that were critical.",
				(Data, Extra) => CombatantFormatSwitch(Data, "critheal%", Extra)));
		CombatantData.ExportVariables.Add("heals",
			new CombatantData.TextExportFormatter("heals", "Heal Count",
				"The total number of heals from this combatant.",
				(Data, Extra) => CombatantFormatSwitch(Data, "heals", Extra)));
		CombatantData.ExportVariables.Add("cures",
			new CombatantData.TextExportFormatter("cures", "Cure or Dispel Count",
				"The total number of times the combatant cured or dispelled",
				(Data, Extra) => CombatantFormatSwitch(Data, "cures", Extra)));
		CombatantData.ExportVariables.Add("maxheal",
			new CombatantData.TextExportFormatter("maxheal", "Highest Heal",
				"The highest single healing amount formatted as [Combatant-]SkillName-Healing#",
				(Data, Extra) => CombatantFormatSwitch(Data, "maxheal", Extra)));
		CombatantData.ExportVariables.Add("MAXHEAL",
		...
		CombatantData.ExportVariables.Add("maxhealward",
			new CombatantData.TextExportFormatter(
				"maxhealward", "Highest Heal/Ward",
				"The highest single healing/warding amount formatted as [Combatant-]SkillName-Healing#",
				(Data, Extra) => CombatantFormatSwitch(Data, "maxhealward", Extra)));
		CombatantData.ExportVariables.Add("MAXHEALWARD",
			new CombatantData.TextExportFormatter(
				"MAXHEALWARD", "Short Highest Heal/Ward",
				"The highest single healing/warding amount formatted as [Combatant-]Healing#",
		...
		CombatantData.ExportVariables.Add("damagetaken",
			new CombatantData.TextExportFormatter(
				"damagetaken", "Damage Received",
				"The total amount of damage this combatant received.",
				(Data, Extra) => CombatantFormatSwitch(Data, "damagetaken", Extra)));
		CombatantData.ExportVariables.Add("damagetaken-*",
			new CombatantData.TextExportFormatter(
				"damagetaken-*", "Damage Received w/suffix",
				"Damage Received divided by 1/K/M/B/T/Q",
		...
		CombatantData.ExportVariables.Add("healstaken",
			new CombatantData.TextExportFormatter(
				"healstaken", "Healing Received",
				"The total amount of healing this combatant received.",
				(Data, Extra) => CombatantFormatSwitch(Data, "healstaken", Extra)));
		CombatantData.ExportVariables.Add("healstaken-*",
			new CombatantData.TextExportFormatter(
				"healstaken-*", "Healing Received w/suffix",
				"Healing Received divided by 1/K/M/B/T/Q",
		...
		CombatantData.ExportVariables.Add("powerdrain",
			new CombatantData.TextExportFormatter(
				"powerdrain", "Power Drain",
				"The amount of power this combatant drained from others.",
				(Data, Extra) => CombatantFormatSwitch(Data, "powerdrain", Extra)));
		CombatantData.ExportVariables.Add("powerdrain-*",
			new CombatantData.TextExportFormatter(
				"powerdrain-*", "Power Drain w/suffix",
				"Power Drain divided by 1/K/M/B/T/Q",
		...
		CombatantData.ExportVariables.Add("powerheal",
			new CombatantData.TextExportFormatter(
				"powerheal", "Power Replenish",
				"The amount of power this combatant replenished to others.",
				(Data, Extra) => CombatantFormatSwitch(Data, "powerheal", Extra)));
		CombatantData.ExportVariables.Add("powerheal-*",
			new CombatantData.TextExportFormatter(
				"powerheal-*", "Power Replenish w/suffix",
				"Power Replenish divided by 1/K/M/B/T/Q",
				(Data, Extra) => CombatantFormatSwitch(Data, "powerheal-*", Extra)));
		CombatantData.ExportVariables.Add("kills",
			new CombatantData.TextExportFormatter("kills", "Killing Blows",
				"The total number of times this character landed a killing blow.",
				(Data, Extra) => CombatantFormatSwitch(Data, "kills", Extra)));
		CombatantData.ExportVariables.Add("deaths",
			new CombatantData.TextExportFormatter("deaths", "Deaths",
				"The total number of times this character was killed by another.",
				(Data, Extra) => CombatantFormatSwitch(Data, "deaths", Extra)));
		...
		DamageTypeData.ColumnDefs.Add("Type",
		...
		DamageTypeData.ColumnDefs.Add("StartTime",
			new DamageTypeData.ColumnDef("StartTime", false, "TIMESTAMP", "StartTime",
				Data => !(Data.StartTime == DateTime.MaxValue)
					? Data.StartTime.ToString("T")
					: "--:--:--",
				Data => !(Data.StartTime == DateTime.MaxValue)
					? Data.StartTime.ToString("u").TrimEnd('Z')
					: "0000-00-00 00:00:00"));
		DamageTypeData.ColumnDefs.Add("EndTime",
		...
		DamageTypeData.ColumnDefs.Add("DPS",
			new DamageTypeData.ColumnDef("DPS", false, "DOUBLE", "DPS",
				Data => Data.DPS.ToString((string?)GetFloatCommas()),
				Data => Data.DPS.ToString(usCulture)));
		DamageTypeData.ColumnDefs.Add("Average",
		...
		DamageTypeData.ColumnDefs.Add("Median",
		...
		DamageTypeData.ColumnDefs.Add("MinHit",
		...
		DamageTypeData.ColumnDefs.Add("MaxHit",
		...
		DamageTypeData.ColumnDefs.Add("Crit%",
		...
		DamageTypeData.ColumnDefs.Add("CritTypes",
			new DamageTypeData.ColumnDef("CritTypes", true, "VARCHAR(32)", "CritTypes",
				DamageTypeDataGetCriticalTypes,
				DamageTypeDataGetCriticalTypes));
		AttackType.ColumnDefs.Clear();
		AttackType.ColumnDefs.Add("EncId",
			new AttackType.ColumnDef("EncId", false, "CHAR(8)", "EncId",
				_ => string.Empty,
				Data => Data.Parent.Parent.Parent.EncId,
				(_, _) => 0));
		AttackType.ColumnDefs.Add("Attacker",
			new AttackType.ColumnDef("Attacker", false, "VARCHAR(64)", "Attacker",
				Data => !Data.Parent.Outgoing ? string.Empty : Data.Parent.Parent.Name,
				Data => !Data.Parent.Outgoing ? string.Empty : Data.Parent.Parent.Name,
				(_, _) => 0));
		AttackType.ColumnDefs.Add("Victim",
			new AttackType.ColumnDef("Victim", false, "VARCHAR(64)", "Victim",
				Data => !Data.Parent.Outgoing ? Data.Parent.Parent.Name : string.Empty,
				Data => !Data.Parent.Outgoing ? Data.Parent.Parent.Name : string.Empty,
				(_, _) => 0));
		AttackType.ColumnDefs.Add("SwingType",
			new AttackType.ColumnDef("SwingType", false, "TINYINT",
				...
				(_, _) => 0));
		AttackType.ColumnDefs.Add("Type",
		...
		AttackType.ColumnDefs.Add("EndTime",
		...
		MasterSwing.ColumnDefs.Add("RelativeTime",
			new MasterSwing.ColumnDef("RelativeTime", true, "FLOAT",
				"RelativeTime",
				Data => (Data.Time - Data.ParentEncounter.StartTime).ToString("T"),
				Data => (Data.Time - Data.ParentEncounter.StartTime).TotalSeconds.ToString(),
				(Left, Right) => Left.Time.CompareTo(Right.Time)));
		MasterSwing.ColumnDefs.Add("Attacker",
			new MasterSwing.ColumnDef("Attacker", true, "VARCHAR(64)", "Attacker",
				Data => Data.Attacker,
				Data => Data.Attacker,
				(Left, Right) => Left.Attacker.CompareTo(Right.Attacker)));
		MasterSwing.ColumnDefs.Add("SwingType",
			new MasterSwing.ColumnDef("SwingType", false, "TINYINT",
				"SwingType",
				Data => Data.SwingType.ToString(),
				Data => Data.SwingType.ToString(), (Left, Right) =>
					Left.SwingType.CompareTo(Right.SwingType)));
		MasterSwing.ColumnDefs.Add("AttackType",
			new MasterSwing.ColumnDef("AttackType", true, "VARCHAR(64)", "AttackType",
				Data => Data.AttackType,
				Data => Data.AttackType,
				(Left, Right) => Left.AttackType.CompareTo(Right.AttackType)));
		MasterSwing.ColumnDefs.Add("DamageType",
			new MasterSwing.ColumnDef("DamageType", true, "VARCHAR(64)", "DamageType",
				Data => Data.DamageType,
				Data => Data.DamageType,
				(Left, Right) => Left.DamageType.CompareTo(Right.DamageType)));
		MasterSwing.ColumnDefs.Add("Victim",
			new MasterSwing.ColumnDef("Victim", true, "VARCHAR(64)", "Victim",
				Data => Data.Victim,
				Data => Data.Victim,
				(Left, Right) => Left.Victim.CompareTo(Right.Victim)));
		...
		MasterSwing.ColumnDefs.Add("Critical",
			new MasterSwing.ColumnDef("Critical", false, "CHAR(1)", "Critical",
				...
				(Left, Right) => Left.Critical.CompareTo(Right.Critical)));
		MasterSwing.ColumnDefs.Add("CriticalStr",
			new MasterSwing.ColumnDef("CriticalStr", true, "VARCHAR(32)", "CriticalStr",
				Data => Data.Tags.TryGetValue("CriticalStr", out var tag) ? (string)tag : "None",
				Data => Data.Tags.TryGetValue("CriticalStr", out var dataTag) ? (string)dataTag : "None",
		...
		MasterSwing.ColumnDefs.Add("Special",
			new MasterSwing.ColumnDef("Special", true, "VARCHAR(64)", "Special",
				Data => Data.Special,
				Data => Data.Special,
				(Left, Right) => Left.Special.CompareTo(Right.Special)));
	...
	private static string AttackTypeGetCriticalTypes(AttackType attackType) {
		...
		foreach (var swing in attackType.Items.Where(swing => swing.Critical)) {
			totalCriticals++;
			if (!swing.Tags.TryGetValue("CriticalStr", out var tag)) continue;
			var criticalType = (string)tag;
			if (criticalType.Contains("Legendary")) legendaryCriticals++;
			else if (criticalType.Contains("Fabled")) fabledCriticals++;
			else if (criticalType.Contains("Mythical")) mythicalCriticals++;
		}
	...
	private static string GetDamageTypeGrouping(DamageTypeData damageData) {
		...
		if (damageData.Outgoing) {
			...
			foreach (var swingTypeLink in CombatantData.SwingTypeToDamageTypeDataLinksOutgoing.SelectMany(swingTypeLink =>
					         swingTypeLink.Value, (swingTypeLink, damageType) => new { swingTypeLink, damageType })
				         .Where(t => damageData.Type == t.damageType)
				         .Select(t => t.swingTypeLink)) {
				@params += $"&swingtype{(swingTypeCount == 0 ? "" : swingTypeCount.ToString())}={swingTypeLink.Key}";
				swingTypeCount++;
			}
		} else {
			@params = $"victim={damageData.Parent.Name}";
			foreach (var swingTypeLink in CombatantData.SwingTypeToDamageTypeDataLinksIncoming.SelectMany(swingTypeLink =>
					         swingTypeLink.Value, (swingTypeLink, damageType) => new { swingTypeLink, damageType })
				         .Where(t => damageData.Type == t.damageType)
				         .Select(t => t.swingTypeLink)) {
				@params += $"&swingtype{(swingTypeCount == 0 ? "" : swingTypeCount.ToString())}={swingTypeLink.Key}";
	...
	private static Color GetSwingTypeColor(int swingType) => swingType switch {
		1 or 2 => Color.Crimson,
		3 => Color.Blue,
		4 => Color.DarkRed,
		5 => Color.DarkOrange,
		8 => Color.DarkOrchid,
	...
	private static string EncounterFormatSwitch(
		...
		try {
			...
			switch (varName) {
				...
				case "duration":
					if (!data.Active) return data.DurationS;
					if (oFormActMain.LastEstimatedTime <= data.StartTime) return "00:00";
				...
				case "DURATION":
					if (!data.Active) return data.Duration.TotalSeconds.ToString("0");
					...
					return "0";
				case "damage":
					num += selectiveAllies.Sum(SelectiveAlly => SelectiveAlly.Damage);
					return num.ToString();
				case "damage-m":
					num += selectiveAllies.Sum(SelectiveAlly2 => SelectiveAlly2.Damage);
					return (num / 1000000.0).ToString("0.00");
				case "damage-b":
					num += selectiveAllies.Sum(SelectiveAlly3 => SelectiveAlly3.Damage);
					return (num / 1000000000.0).ToString("0.00");
				case "damage-*":
					num += selectiveAllies.Sum(SelectiveAlly4 => SelectiveAlly4.Damage);
					return oFormActMain.CreateDamageString(num, true, true);
				case "DAMAGE-k":
					num += selectiveAllies.Sum(SelectiveAlly5 => SelectiveAlly5.Damage);
					return (num / 1000.0).ToString("0");
				case "DAMAGE-m":
					num += selectiveAllies.Sum(SelectiveAlly6 => SelectiveAlly6.Damage);
					return (num / 1000000.0).ToString("0");
				case "DAMAGE-b":
					num += selectiveAllies.Sum(SelectiveAlly7 => SelectiveAlly7.Damage);
					return (num / 1000000000.0).ToString("0");
				case "DAMAGE-*":
					num += selectiveAllies.Sum(SelectiveAlly8 => SelectiveAlly8.Damage);
					return oFormActMain.CreateDamageString(num, true, false);
				case "healed":
					num2 += selectiveAllies.Sum(SelectiveAlly9 => SelectiveAlly9.Healed);
					return num2.ToString();
				case "healed-*":
					num2 += selectiveAllies.Sum(SelectiveAlly10 => SelectiveAlly10.Healed);
					return oFormActMain.CreateDamageString(num2, true, true);
				case "swings":
					num3 += selectiveAllies.Sum(SelectiveAlly11 => SelectiveAlly11.Swings);
					return num3.ToString();
				case "hits":
					num4 += selectiveAllies.Sum(SelectiveAlly12 => SelectiveAlly12.Hits);
					return num4.ToString();
				case "crithits":
					num5 += selectiveAllies.Sum(SelectiveAlly13 => SelectiveAlly13.CritHits);
					return num5.ToString();
				case "crithit%":
					num5 += selectiveAllies.Sum(SelectiveAlly14 => SelectiveAlly14.CritHits);
					num4 += selectiveAllies.Sum(SelectiveAlly15 => SelectiveAlly15.Hits);
					return (num5 / (float)num4).ToString("0'%");
				case "heals":
					num6 += selectiveAllies.Sum(SelectiveAlly16 => SelectiveAlly16.Heals);
					return num6.ToString();
				case "critheals":
					num7 += selectiveAllies.Sum(SelectiveAlly17 => SelectiveAlly17.CritHits);
					return num7.ToString();
				case "critheal%":
					num7 += selectiveAllies.Sum(SelectiveAlly18 => SelectiveAlly18.CritHeals);
					num6 += selectiveAllies.Sum(SelectiveAlly19 => SelectiveAlly19.Heals);
					return (num7 / (float)num6).ToString("0'%");
				case "cures":
					num8 += selectiveAllies.Sum(SelectiveAlly20 => SelectiveAlly20.CureDispels);
					return num8.ToString();
				case "misses":
					num9 += selectiveAllies.Sum(SelectiveAlly21 => SelectiveAlly21.Misses);
					return num9.ToString();
				case "hitfailed":
					num10 += selectiveAllies.Sum(SelectiveAlly22 => SelectiveAlly22.Blocked);
					return num10.ToString();
				case "TOHIT":
					num11 += selectiveAllies.Sum(SelectiveAlly23 => SelectiveAlly23.ToHit);
					return (num11 / selectiveAllies.Count).ToString("0");
				case "DPS":
				case "ENCDPS":
					num += selectiveAllies.Sum(SelectiveAlly24 => SelectiveAlly24.Damage);
					return (num / data.Duration.TotalSeconds).ToString("0");
				case "DPS-*":
				case "ENCDPS-*":
					num += selectiveAllies.Sum(SelectiveAlly25 => SelectiveAlly25.Damage);
					num12 = num / data.Duration.TotalSeconds;
					return oFormActMain.CreateDamageString((long)num12, true, false);
				case "DPS-k":
				case "ENCDPS-k":
					num += selectiveAllies.Sum(SelectiveAlly26 => SelectiveAlly26.Damage);
					num12 = num / data.Duration.TotalSeconds;
					return (num12 / 1000.0).ToString("0");
				case "ENCDPS-m":
					num += selectiveAllies.Sum(SelectiveAlly27 => SelectiveAlly27.Damage);
					num12 = num / data.Duration.TotalSeconds;
					return (num12 / 1000000.0).ToString("0");
				case "ENCHPS":
					num2 += selectiveAllies.Sum(SelectiveAlly28 => SelectiveAlly28.Healed);
					return (num2 / data.Duration.TotalSeconds).ToString("0");
				case "ENCHPS-k":
					num2 += selectiveAllies.Sum(SelectiveAlly29 => SelectiveAlly29.Healed);
					num13 = num2 / data.Duration.TotalSeconds;
					return (num13 / 1000.0).ToString("0");
				case "ENCHPS-m":
					num2 += selectiveAllies.Sum(SelectiveAlly30 => SelectiveAlly30.Healed);
					num13 = num2 / data.Duration.TotalSeconds;
					return (num13 / 1000000.0).ToString("0");
				case "ENCHPS-*":
					num2 += selectiveAllies.Sum(SelectiveAlly31 => SelectiveAlly31.Healed);
					num13 = num2 / data.Duration.TotalSeconds;
					return oFormActMain.CreateDamageString((long)num13, true, false);
				case "tohit":
					num11 += selectiveAllies.Sum(SelectiveAlly32 => SelectiveAlly32.ToHit);
					return (num11 / selectiveAllies.Count).ToString("F");
				case "dps":
				case "encdps":
					num += selectiveAllies.Sum(SelectiveAlly33 => SelectiveAlly33.Damage);
					return (num / data.Duration.TotalSeconds).ToString("F");
				case "dps-k":
				case "encdps-k":
					num += selectiveAllies.Sum(SelectiveAlly34 => SelectiveAlly34.Damage);
					num12 = num / data.Duration.TotalSeconds;
					return (num12 / 1000.0).ToString("F");
				case "encdps-m":
					num += selectiveAllies.Sum(SelectiveAlly35 => SelectiveAlly35.Damage);
					num12 = num / data.Duration.TotalSeconds;
					return (num12 / 1000000.0).ToString("F");
				case "encdps-*":
					num += selectiveAllies.Sum(SelectiveAlly36 => SelectiveAlly36.Damage);
					num12 = num / data.Duration.TotalSeconds;
					return oFormActMain.CreateDamageString((long)num12, true, true);
				case "enchps":
					num2 += selectiveAllies.Sum(SelectiveAlly37 => SelectiveAlly37.Healed);
					return (num2 / data.Duration.TotalSeconds).ToString("F");
				case "enchps-k":
					num2 += selectiveAllies.Sum(SelectiveAlly38 => SelectiveAlly38.Healed);
					num13 = num2 / data.Duration.TotalSeconds;
					return (num13 / 1000.0).ToString("F");
				case "enchps-m":
					num2 += selectiveAllies.Sum(SelectiveAlly39 => SelectiveAlly39.Healed);
					num13 = num2 / data.Duration.TotalSeconds;
					return (num13 / 1000000.0).ToString("F");
				case "enchps-*":
					num2 += selectiveAllies.Sum(SelectiveAlly40 => SelectiveAlly40.Healed);
					num13 = num2 / data.Duration.TotalSeconds;
					return oFormActMain.CreateDamageString((long)num13, true, true);
				case "healstaken":
					num14 += selectiveAllies.Sum(SelectiveAlly41 => SelectiveAlly41.HealsTaken);
					return num14.ToString();
				case "healstaken-*":
					num14 += selectiveAllies.Sum(SelectiveAlly42 => SelectiveAlly42.HealsTaken);
					return oFormActMain.CreateDamageString(num14, true, true);
				case "damagetaken":
					num15 += selectiveAllies.Sum(SelectiveAlly43 => SelectiveAlly43.DamageTaken);
					return num15.ToString();
				case "damagetaken-*":
					num15 += selectiveAllies.Sum(SelectiveAlly44 => SelectiveAlly44.DamageTaken);
					return oFormActMain.CreateDamageString(num15, true, true);
				case "powerdrain":
					num16 += selectiveAllies.Sum(SelectiveAlly45 => SelectiveAlly45.PowerDamage);
					return num16.ToString();
				case "powerdrain-*":
					num16 += selectiveAllies.Sum(SelectiveAlly46 => SelectiveAlly46.PowerDamage);
					return oFormActMain.CreateDamageString(num16, true, true);
				case "powerheal":
					num17 += selectiveAllies.Sum(SelectiveAlly47 => SelectiveAlly47.PowerReplenish);
					return num17.ToString();
				case "powerheal-*":
					num17 += selectiveAllies.Sum(SelectiveAlly48 => SelectiveAlly48.PowerReplenish);
					return oFormActMain.CreateDamageString(num17, true, true);
				case "kills":
					num18 += selectiveAllies.Sum(SelectiveAlly49 => SelectiveAlly49.Kills);
					return num18.ToString();
				case "deaths":
					num19 += selectiveAllies.Sum(SelectiveAlly50 => SelectiveAlly50.Deaths);
