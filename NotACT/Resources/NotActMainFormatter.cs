    ...
    public static void SetupEnvironment()
    {
        ...
        EncounterData.ColumnDefs.Add(
            ...
            new EncounterData.ColumnDef("EncId", DefaultVisible: false, "CHAR(8)", "EncId",
                                        Data => string.Empty, Data => Data.EncId));
        EncounterData.ColumnDefs.Add(
            "Title",
                                                                 ...
                                                                 (Left, Right) =>
                                                                     Left.GetThreatDelta("Threat (Out)")
                                                                         .CompareTo(
                                                                             Right.GetThreatDelta(
                                                                                 "Threat (Out)"))));
        CombatantData.ColumnDefs["Damage"].GetCellForeColor = Data => Color.DarkRed;
        CombatantData.ColumnDefs["Damage%"].GetCellForeColor = Data => Color.DarkRed;
        CombatantData.ColumnDefs["Healed"].GetCellForeColor = Data => Color.DarkBlue;
        CombatantData.ColumnDefs["Healed%"].GetCellForeColor = Data => Color.DarkBlue;
        CombatantData.ColumnDefs["PowerDrain"].GetCellForeColor = Data => Color.DarkMagenta;
        CombatantData.ColumnDefs["DPS"].GetCellForeColor = Data => Color.DarkRed;
        CombatantData.ColumnDefs["EncDPS"].GetCellForeColor = Data => Color.DarkRed;
        CombatantData.ColumnDefs["EncHPS"].GetCellForeColor = Data => Color.DarkBlue;
        CombatantData.ColumnDefs["DamageTaken"].GetCellForeColor = Data => Color.DarkOrange;
        ...
        DamageTypeData.ColumnDefs.Add(
            ...
            new DamageTypeData.ColumnDef("Grouping", DefaultVisible: false, "VARCHAR(92)", "Grouping",
                                         Data => string.Empty, GetDamageTypeGrouping));
        DamageTypeData.ColumnDefs.Add(
            "Type",
