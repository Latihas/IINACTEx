...
internal class LineCEDirector : LineBaseCustom<
	...
	internal struct CEDirector_v62 : IPacketStruct {
		...
		[FieldOffset(0x4)] public ushort timeRemaining;
		[FieldOffset(0x6)] public ushort unk9;
		[FieldOffset(0x8)] public byte ceKey;
		[FieldOffset(0x9)] public byte numPlayers;
		[FieldOffset(0xA)] public byte status;
		[FieldOffset(0xB)] public byte unk10;
		[FieldOffset(0xC)] public byte progress;
		[FieldOffset(0xD)] public byte unk11;
		[FieldOffset(0xE)] public byte unk12;
		[FieldOffset(0xF)] public byte unk13;
	...
	public LineCEDirector(TinyIoCContainer container)
		...
		ffxiv.RegisterZoneChangeDelegate((_, _) => ces.Clear());
	}
}