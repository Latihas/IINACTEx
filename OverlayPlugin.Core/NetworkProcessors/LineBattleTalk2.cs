...
internal class LineBattleTalk2(TinyIoCContainer container) : LineBaseCustom<
	LineBattleTalk2.BattleTalk2_v655,
	LineBattleTalk2.BattleTalk2_v655,
	LineBattleTalk2.BattleTalk2_v655,
	LineBattleTalk2.BattleTalk2_v655>(container, LogFileLineID, logLineName, MachinaPacketName) {
	...
	internal struct BattleTalk2_v655 : IPacketStruct {
		...
		[FieldOffset(0x8)] public uint instanceContentID;
		[FieldOffset(0xC)] public uint npcNameID;
		[FieldOffset(0x10)] public uint instanceContentTextID;
		[FieldOffset(0x14)] public uint displayMS;
		[FieldOffset(0x18)] public uint param1;
		[FieldOffset(0x1C)] public uint param2;
		[FieldOffset(0x20)] public uint param3;
		[FieldOffset(0x24)] public uint param4;
