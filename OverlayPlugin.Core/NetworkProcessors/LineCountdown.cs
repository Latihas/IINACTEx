...
internal class LineCountdown(TinyIoCContainer container) : LineBaseCustom<
	...
	internal unsafe struct Countdown_v655 : IPacketStruct {
		...
		[FieldOffset(0x0)] public uint countdownStarterActorID;
		[FieldOffset(0x4)] public ushort countdownStarterWorldId;

		[FieldOffset(0x6)] public ushort countdownTimeSeconds;
		[FieldOffset(0x8)] public byte countdownResultCode;

		[FieldOffset(0xB)] public fixed byte countdownStarterName[32];
	...
	internal unsafe struct Countdown_v730 : IPacketStruct {
		...
		[FieldOffset(0x10)] public uint countdownStarterActorID;
		[FieldOffset(0x14)] public ushort countdownStarterWorldId;

		[FieldOffset(0x16)] public ushort countdownTimeSeconds;
		[FieldOffset(0x18)] public byte countdownResultCode;

		[FieldOffset(0x1B)] public fixed byte countdownStarterName[32];
