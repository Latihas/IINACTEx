...
internal class LineCountdownCancel(TinyIoCContainer container) : LineBaseCustom<
	LineCountdownCancel.CountdownCancel_v730,
	LineCountdownCancel.CountdownCancel_v730,
	LineCountdownCancel.CountdownCancel_v655,
	LineCountdownCancel.CountdownCancel_v655>(container, LogFileLineID, logLineName, MachinaPacketName) {
	...
	internal unsafe struct CountdownCancel_v655 : IPacketStruct {
		...
		[FieldOffset(0x0)] public uint countdownCancellerActorID;
		[FieldOffset(0x4)] public ushort countdownCancellerWorldId;

		[FieldOffset(0x8)] public fixed byte countdownCancellerName[32];
	...
	internal unsafe struct CountdownCancel_v730 : IPacketStruct {
		...
		[FieldOffset(0x10)] public uint countdownCancellerActorID;
		[FieldOffset(0x14)] public ushort countdownCancellerWorldId;

		[FieldOffset(0x18)] public fixed byte countdownCancellerName[32];
