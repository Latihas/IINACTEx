...
internal class CombatantMemory71(TinyIoCContainer container) : CombatantMemory(container, charmapSignature, CombatantMemory.Size, EffectMemory.Size, 629), ICombatantMemory71 {
	...
	private unsafe struct CombatantMemory {
		...
		[FieldOffset(0xC70)] public byte WeaponId;

		// TODO: Verify for 7.1. Could potentially be 0xD50, 0xF30, 0x1110
		[FieldOffset(0xD50)] public uint PCTargetID;

		// TODO: Verify for 7.1. Could potentially be 0x19EC or 0x2288
		[FieldOffset(0x2288)] public uint NPCTargetID;

		[FieldOffset(0x22B4)] public uint BNpcNameID;

		[FieldOffset(0x22D8)] public ushort CurrentWorldID;

		[FieldOffset(0x22DA)] public ushort WorldID;

		[FieldOffset(0x2338)] public fixed byte Effects[EffectBytes];

		[FieldOffset(0x2620)] public byte IsCasting1;

		[FieldOffset(0x2622)] public byte IsCasting2;

		[FieldOffset(0x2624)] public uint CastBuffID;

		[FieldOffset(0x2630)] public uint CastTargetID;

		[FieldOffset(0x2640)] public float CastGroundTargetX;

		[FieldOffset(0x2644)] public float CastGroundTargetY;

		[FieldOffset(0x2648)] public float CastGroundTargetZ;

		[FieldOffset(0x2654)] public float CastDurationCurrent;

		[FieldOffset(0x2658)] public float CastDurationMax;
