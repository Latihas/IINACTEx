...
internal class CombatantMemory73 : CombatantMemory, ICombatantMemory73 {
    ...
    protected override unsafe Combatant GetCombatantFromByteArray(byte[] source, uint mycharID, bool isPlayer, bool exceptEffects = false) {
        fixed (byte* p = source) {
            ...
            var combatant = combatantPool.Get();
            ...
            combatant.Effects = exceptEffects ? [] : GetEffectEntries(mem.Effects, (ObjectType)mem.Type, mycharID);
    ...
    private unsafe struct CombatantMemory {
        ...
        [FieldOffset(0x84)] public uint BNpcID;

        [FieldOffset(0x88)] public uint OwnerID;

        [FieldOffset(0x90)] public byte Type;

        [FieldOffset(0x96)] public byte EffectiveDistance;

        [FieldOffset(0x98)] public byte Status;

        [FieldOffset(0xB0)] public Single PosX;

        [FieldOffset(0xB4)] public Single PosY;

        [FieldOffset(0xB8)] public Single PosZ;

        [FieldOffset(0xC0)] public Single Heading;

        [FieldOffset(0xD0)] public Single Radius;

        [FieldOffset(0x118)] public int ModelStatus;

        [FieldOffset(0x1AC)] public int CurrentHP;

        [FieldOffset(0x1B0)] public int MaxHP;

        [FieldOffset(0x1B4)] public int CurrentMP;

        [FieldOffset(0x1B8)] public int MaxMP;

        [FieldOffset(0x1BC)] public ushort CurrentGP;

        [FieldOffset(0x1BE)] public ushort MaxGP;

        [FieldOffset(0x1C0)] public ushort CurrentCP;

        [FieldOffset(0x1C2)] public ushort MaxCP;

        [FieldOffset(0x1C4)] public short TransformationId;

        [FieldOffset(0x1CA)] public byte Job;

        [FieldOffset(0x1CB)] public byte Level;

        [FieldOffset(0xCE0)] public byte WeaponId;

        [FieldOffset(0xDC0)] public uint PCTargetID;

        [FieldOffset(0x22F8)] public uint NPCTargetID;

        [FieldOffset(0x2328)] public uint BNpcNameID;

        [FieldOffset(0x2350)] public ushort CurrentWorldID;

        [FieldOffset(0x2352)] public ushort WorldID;

        [FieldOffset(0x23A8)] public fixed byte Effects[EffectBytes];

        [FieldOffset(0x2780)] public byte IsCasting1;

        [FieldOffset(0x2782)] public byte IsCasting2;

        [FieldOffset(0x2784)] public uint CastBuffID;

        [FieldOffset(0x2790)] public uint CastTargetID;

        [FieldOffset(0x27A0)] public float CastGroundTargetX;

        [FieldOffset(0x27A4)] public float CastGroundTargetY;

        [FieldOffset(0x27A8)] public float CastGroundTargetZ;

        [FieldOffset(0x27B4)] public float CastDurationCurrent;

        [FieldOffset(0x27B8)] public float CastDurationMax;
    ...
    protected new unsafe EffectEntry GetEffectEntryFromByteArray(byte[] source, int num = 0) {
        fixed (byte* p = source) {
            var mem = *(EffectMemory73*)&p[num * EffectMemory73.Size];
