...
internal class CombatantMemory70 : CombatantMemory, ICombatantMemory70 {
    ...
    private unsafe struct CombatantMemory {
        ...
        [FieldOffset(0x114)] public int ModelStatus;

        [FieldOffset(0x1BC)] public int CurrentHP;

        [FieldOffset(0x1C0)] public int MaxHP;

        [FieldOffset(0x1C4)] public int CurrentMP;

        [FieldOffset(0x1C8)] public int MaxMP;

        [FieldOffset(0x1CC)] public ushort CurrentGP;

        [FieldOffset(0x1CE)] public ushort MaxGP;

        [FieldOffset(0x1D0)] public ushort CurrentCP;

        [FieldOffset(0x1D2)] public ushort MaxCP;

        [FieldOffset(0x1D4)] public short TransformationId;

        [FieldOffset(0x1DA)] public byte Job;

        [FieldOffset(0x1DB)] public byte Level;
        ...
        [FieldOffset(0x2200)] public uint NPCTargetID;

        [FieldOffset(0x2240)] public uint BNpcNameID;

        [FieldOffset(0x2268)] public ushort CurrentWorldID;

        [FieldOffset(0x226A)] public ushort WorldID;

        [FieldOffset(0x22C8)] public fixed byte Effects[EffectBytes];

        [FieldOffset(0x25B0)] public byte IsCasting1;

        [FieldOffset(0x25B2)] public byte IsCasting2;

        [FieldOffset(0x25B4)] public uint CastBuffID;

        [FieldOffset(0x25C0)] public uint CastTargetID;

        [FieldOffset(0x25D0)] public float CastGroundTargetX;

        [FieldOffset(0x25D4)] public float CastGroundTargetY;

        [FieldOffset(0x25D8)] public float CastGroundTargetZ;

        [FieldOffset(0x25E4)] public float CastDurationCurrent;

        [FieldOffset(0x25E8)] public float CastDurationMax;
