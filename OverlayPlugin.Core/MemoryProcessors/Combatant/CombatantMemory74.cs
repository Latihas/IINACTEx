...
internal class CombatantMemory74 : CombatantMemory, ICombatantMemory74 {
    ...
    private unsafe struct CombatantMemory {
        ...
        [FieldOffset(0xCF0)] public byte WeaponId;

        [FieldOffset(0xDD0)] public uint PCTargetID;

        [FieldOffset(0x2308)] public uint NPCTargetID;

        [FieldOffset(0x2338)] public uint BNpcNameID;

        [FieldOffset(0x2360)] public ushort CurrentWorldID;

        [FieldOffset(0x2362)] public ushort WorldID;

        [FieldOffset(0x23B8)] public fixed byte Effects[EffectBytes];

        [FieldOffset(0x2790)] public byte IsCasting1;

        [FieldOffset(0x2792)] public byte IsCasting2;

        [FieldOffset(0x2794)] public uint CastBuffID;

        [FieldOffset(0x27A0)] public uint CastTargetID;

        [FieldOffset(0x27B0)] public float CastGroundTargetX;

        [FieldOffset(0x27B4)] public float CastGroundTargetY;

        [FieldOffset(0x27B8)] public float CastGroundTargetZ;

        [FieldOffset(0x27C4)] public float CastDurationCurrent;

        [FieldOffset(0x27C8)] public float CastDurationMax;
    ...
    protected new unsafe EffectEntry GetEffectEntryFromByteArray(byte[] source, int num = 0) {
        fixed (byte* p = source) {
            var mem = *(EffectMemory74*)&p[num * EffectMemory74.Size];
