...
public class FFXIVProcessCn : FFXIVProcess {
    ...
    public struct RedMageJobMemory {
        [FieldOffset(0x00)] public byte whiteMana;

        [FieldOffset(0x01)] public byte blackMana;

        [FieldOffset(0x02)] public byte manaStacks;
    }

    [Serializable]
    [StructLayout(LayoutKind.Explicit)]
    public struct WarriorJobMemory {
        [FieldOffset(0x00)] public byte beast;
    }

    [Serializable]
    [StructLayout(LayoutKind.Explicit)]
    public struct DarkKnightJobMemory {
        [FieldOffset(0x00)] public byte blood;

        [FieldOffset(0x02)] public ushort darksideMilliseconds;

        [FieldOffset(0x04)] public byte darkArts;

        [FieldOffset(0x06)] public ushort livingShadowMilliseconds;
    }

    [Serializable]
    [StructLayout(LayoutKind.Explicit)]
    public struct PaladinJobMemory {
        [FieldOffset(0x00)] public byte oath;
    }

    [Serializable]
    [StructLayout(LayoutKind.Explicit)]
    public struct GunbreakerJobMemory {
        [FieldOffset(0x00)] public byte cartridges;

        [FieldOffset(0x02)] private ushort continuationMilliseconds; // Is 15000 if and only if continuationState is not zero.

        [FieldOffset(0x04)] public byte continuationState;
    }
    ...
    public struct BardJobMemory {
        ...
        [FieldOffset(0x00)] public ushort songMilliseconds; // 00~01
        ...
        [FieldOffset(0x04)] public byte songProcs;

        [FieldOffset(0x05)] public byte soulGauge;

        [FieldOffset(0x06)] public byte LastCodaCost;

        [NonSerialized] [FieldOffset(0x07)] private SongFlags songFlags;
        ...
        public string[] coda => [
            songFlags.HasFlag(SongFlags.BalladCoda) ? "Ballad" : "None",
            songFlags.HasFlag(SongFlags.PaeonCoda) ? "Paeon" : "None",
            songFlags.HasFlag(SongFlags.MinuetCoda) ? "Minuet" : "None"
        ];
    }
    ...
    public struct DancerJobMemory {
        ...
        [FieldOffset(0x00)] public byte feathers;

        [FieldOffset(0x01)] public byte esprit;

        [NonSerialized] [FieldOffset(0x02)] private Step step1; // Order of steps in current Standard Step/Technical Step combo.

        [NonSerialized] [FieldOffset(0x03)] private Step step2;

        [NonSerialized] [FieldOffset(0x04)] private Step step3;

        [NonSerialized] [FieldOffset(0x05)] private Step step4;

        [FieldOffset(0x06)] public byte currentStep; // Number of steps executed in current Standard Step/Technical Step combo.
    ...
    public struct DragoonJobMemory {
        [NonSerialized] [FieldOffset(0x00)] private ushort blood_or_life_ms;

        [NonSerialized] [FieldOffset(0x02)] private byte stance; // 0 = None, 1 = Blood, 2 = Life

        [FieldOffset(0x03)] public byte eyesAmount;
        ...
        [FieldOffset(0x04)] public byte firstmindsFocus;
    }

    [Serializable]
    [StructLayout(LayoutKind.Explicit)]
    public struct NinjaJobMemory {
        [FieldOffset(0x00)] public byte ninkiAmount;

        [FieldOffset(0x02)] public byte kazematoi;
    }
    ...
    public struct BlackMageJobMemory {
        ...
        [FieldOffset(0x00)] public ushort nextPolyglotMilliseconds; // Number of ms left before polyglot proc.

        [FieldOffset(0x02)] public sbyte umbralStacks; // Positive = Umbral Fire Stacks, Negative = Umbral Ice Stacks.

        [FieldOffset(0x03)] public byte umbralHearts;

        [FieldOffset(0x04)] public byte polyglot;

        [NonSerialized] [FieldOffset(0x05)] private EnochianFlags enochian_state;
        ...
        public int astralSoulStacks => (int)enochian_state >> 2 & 0x7; // = 0b111, to get the last 3 bits.
    }

    [StructLayout(LayoutKind.Explicit)]
    public struct WhiteMageJobMemory {
        [FieldOffset(0x02)] public ushort lilyMilliseconds; // Number of ms left before lily gain.

        [FieldOffset(0x04)] public byte lilyStacks;

        [FieldOffset(0x05)] public byte bloodlilyStacks;
    }
    ...
    public struct SummonerJobMemory {
        ...
        [FieldOffset(0x00)] public ushort tranceMilliseconds;

        [FieldOffset(0x02)] public ushort attunementMilliseconds;

        /// <summary>
        ///     0x04: 0x17 = Summoned other than Carbuncle, 0x00 = Other Condition
        /// </summary>
        [NonSerialized] [FieldOffset(0x04)] private byte _summonStatus;

        /// <summary>
        ///     (From right to left)
        ///     1-2 bits: Active Primal
        ///     3-5 bits: Counts of Attunement Stacks
        [NonSerialized] [FieldOffset(0x06)] private byte _attunement;

        [NonSerialized] [FieldOffset(0x07)] private Stance stance;

        public bool summonStatus => _summonStatus != 0;

        public int attunement => _attunement >> 2 & 0x7; // = 0b111, to get the last 3 bits.

        public string activePrimal => ((ActiveArcanum)(_attunement & 0x3)).ToString();
        ...
        public string[] usableArcanum
        {
            get
            {
                ...
                foreach (var flag in new List<Stance> {
                             Stance.Ruby,
                             Stance.Topaz,
                             Stance.Emerald
                         }) {
        ...
        public int aetherflowStacks => stance.HasFlag(Stance.AetherFlow3) ? 3 :
    ...
    public struct ScholarJobMemory {
        [FieldOffset(0x00)] public byte aetherflowStacks;

        [FieldOffset(0x01)] public byte fairyGauge;

        [FieldOffset(0x02)] public ushort fairyMilliseconds; // Seraph time left ms.

        [FieldOffset(0x04)] public byte fairyStatus; // Seraph: 6, else 0.
    }
    ...
    public struct MonkJobMemory {
        ...
        [FieldOffset(0x00)] public byte chakraStacks;

        [NonSerialized] [FieldOffset(0x01)] private Beast beastChakra1;

        [NonSerialized] [FieldOffset(0x02)] private Beast beastChakra2;

        [NonSerialized] [FieldOffset(0x03)] private Beast beastChakra3;

        [NonSerialized] [FieldOffset(0x04)] private byte Fury;

        [NonSerialized] [FieldOffset(0x05)] private byte Nadi;

        [FieldOffset(0x06)] public ushort MasterfulReadyMilisecond;
        ...
        public int opoopoFury => Fury & 0x3;

        public int raptorFury => Fury >> 2 & 0x3;

        public int coeurlFury => Fury >> 4 & 0x3;
    }

    [StructLayout(LayoutKind.Explicit)]
    public struct MachinistJobMemory {
        [FieldOffset(0x00)] public ushort overheatMilliseconds;

        [FieldOffset(0x02)] public ushort batteryMilliseconds;

        [FieldOffset(0x04)] public byte heat;

        [FieldOffset(0x05)] public byte battery;

        [FieldOffset(0x06)] public byte lastBatteryAmount;

        [NonSerialized] [FieldOffset(0x07)] private byte chargeTimerState;
    ...
    public struct AstrologianJobMemory {
        ...
        [NonSerialized] [FieldOffset(0x00)] private ushort _card;

        [NonSerialized] [FieldOffset(0x02)] private byte _nextdraw;

        public string card1 => ((Card)(_card & 0xF)).ToString();

        public string card2 => ((Card)(_card >> 4 & 0xF)).ToString();

        public string card3 => ((Card)(_card >> 8 & 0xF)).ToString();

        public string card4 => ((Card)(_card >> 12 & 0xF)).ToString();
    ...
    public struct SamuraiJobMemory {
        [FieldOffset(0x03)] public byte kenki;

        [FieldOffset(0x04)] public byte meditationStacks;

        [NonSerialized] [FieldOffset(0x05)] private byte sen_bits;
    ...
    public struct SageJobMemory {
        [FieldOffset(0x00)] public ushort addersgallMilliseconds; // the addersgall gauge elapsed in milliseconds, from 0 to 19999.
    ...
    public struct ReaperJobMemory {
        [FieldOffset(0x00)] public byte soul;

        [FieldOffset(0x01)] public byte shroud;

        [FieldOffset(0x02)] public ushort enshroudMilliseconds;

        [FieldOffset(0x04)] public byte lemureShroud;

        [FieldOffset(0x05)] public byte voidShroud;
    }
    ...
    public struct ViperJobMemory {
        ...
        [FieldOffset(0x00)] public byte rattlingCoilStacks;

        [FieldOffset(0x01)] public byte anguineTribute;

        [FieldOffset(0x02)] public byte serpentOffering;

        [NonSerialized] [FieldOffset(0x03)] private AdvancedCombo _advancedCombo;

        public string advancedCombo => _advancedCombo.ToString();

        [FieldOffset(0x06)] public ushort reawakenedTimer;
    }
    ...
    public struct PictomancerJobMemory {
        ...
        [FieldOffset(0x00)] public byte paletteGauge;
        [FieldOffset(0x02)] public byte paint;

        [NonSerialized] [FieldOffset(0x03)] private CanvasFlags canvasFlags;
        ...
        [NonSerialized] [FieldOffset(0x04)] private CreatureFlags creatureFlags;
