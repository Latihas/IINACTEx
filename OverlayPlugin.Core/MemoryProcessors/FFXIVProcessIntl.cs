...
public class FFXIVProcessIntl : FFXIVProcess {
    ...
    public struct BardJobMemory {
        ...
        [FieldOffset(0x00)] public ushort songMilliseconds;

        [FieldOffset(0x04)] public byte songProcs;

        [FieldOffset(0x05)] public byte soulGauge;

        [NonSerialized] [FieldOffset(0x06)] private SongFlags songFlags;
    ...
    public struct NinjaJobMemory {
        [FieldOffset(0x00)] public ushort hutonMilliseconds;

        [FieldOffset(0x02)] public byte ninkiAmount;

        [FieldOffset(0x03)] private byte hutonCount; // Why though?
    }
    ...
    public struct PictomancerJobMemory {
        ...
        [FieldOffset(0x00)] public byte palleteGauge;
