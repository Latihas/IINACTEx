...
internal partial class JobGaugeMemory70 : JobGaugeMemory, IJobGaugeMemory70 {
	...
	public unsafe struct JobGaugeManager {
		[JsonIgnore] [FieldOffset(0x00)] public JobGauge* CurrentGauge;
		...
		[JsonIgnore] [FieldOffset(0x10)] public fixed byte RawGaugeData[8];

		[FieldOffset(0x58)] public byte ClassJobID;

		public byte[] GetRawGaugeData => [
	...
	public struct AstrologianGauge : IBaseAstrologianGauge {
		...
		public AstrologianSeal[] CurrentSeals => [
			(AstrologianSeal)(3 & Seals >> 0),
			(AstrologianSeal)(3 & Seals >> 2),
			(AstrologianSeal)(3 & Seals >> 4)
		];
	...
	public unsafe struct DancerGauge : IBaseDancerGauge {
		...
		byte[] IBaseDancerGauge.DanceSteps => [DanceSteps[0], DanceSteps[1], DanceSteps[2], DanceSteps[3]];
