...
public class FFXIVProcessKo(TinyIoCContainer container) : FFXIVProcess(container) {
	...
	public struct BardJobMemory {
		...
		[FieldOffset(0x02)] public byte songProcs;

		[FieldOffset(0x03)] public byte soulGauge;
	...
	public struct DancerJobMemory {
		...
		public string steps {
			get {
				...
				_steps += step2 != Step.None ? ", " + step2 : "";
				_steps += step3 != Step.None ? ", " + step3 : "";
				_steps += step4 != Step.None ? ", " + step4 : "";
				return _steps;
			}
		}
	}
	...
	public struct NinjaJobMemory {
		[FieldOffset(0x00)] public uint hutonMilliseconds;

		[FieldOffset(0x04)] public byte ninkiAmount;

		[FieldOffset(0x05)] private byte hutonCount; // Why though?
	}

	[StructLayout(LayoutKind.Explicit)]
	public struct ThaumaturgeJobMemory {
		[FieldOffset(0x02)] public ushort umbralMilliseconds; // Number of ms left in umbral fire/ice.

		[FieldOffset(0x04)] public sbyte umbralStacks; // Positive = Umbral Fire Stacks, Negative = Umbral Ice Stacks.
	}
	...
	public struct BlackMageJobMemory {
		...
		[FieldOffset(0x05)] public byte umbralHearts;

		[FieldOffset(0x06)] public byte foulCount;

		[NonSerialized] [FieldOffset(0x07)] private byte enochian_state; // Bit 0 = Enochian active. Bit 1 = Polygot active.
	...
	public struct SummonerJobMemory {
		[FieldOffset(0x00)] public ushort stanceMilliseconds; // Dreadwyrm or Bahamut/Phoenix time left in ms.

		[FieldOffset(0x02)] public byte bahamutStance; // 5 if Bahamut/Phoenix summoned, else 0.

		[FieldOffset(0x03)] public byte bahamutSummoned; // 1 if Bahamut/Phoenix summoned, else 0.

		[NonSerialized] [FieldOffset(0x04)] private byte stacks; // Bits 1-2: Aetherflow. Bits 3-4: Dreadwyrm. Bit 5: Phoenix ready.
	...
	public struct ScholarJobMemory {
		[FieldOffset(0x02)] public byte aetherflowStacks;

		[FieldOffset(0x03)] public byte fairyGauge;

		[FieldOffset(0x04)] public ushort fairyMilliseconds; // Seraph time left ms.

		[FieldOffset(0x06)] public byte
	...
	public struct PuglistJobMemory {
		[FieldOffset(0x00)] public ushort lightningMilliseconds;

		[FieldOffset(0x02)] public byte lightningStacks;
	}
	...
	public struct MonkJobMemory {
		...
		[FieldOffset(0x03)] public byte chakraStacks;
	}
	...
	public struct AstrologianJobMemory {
		...
		[FieldOffset(0x04)] private Card _heldCard;

		[NonSerialized] [FieldOffset(0x05)] private Arcanum arcanum_1;

		[NonSerialized] [FieldOffset(0x06)] private Arcanum arcanum_2;

		[NonSerialized] [FieldOffset(0x07)] private Arcanum arcanum_3;
		...
		public string arcanums {
			get {
				...
				_arcanums += arcanum_2 != Arcanum.None ? ", " + arcanum_2 : "";
				_arcanums += arcanum_3 != Arcanum.None ? ", " + arcanum_3 : "";
				return _arcanums;
			}
		}
	}
	...
	public struct SamuraiJobMemory {
		[FieldOffset(0x04)] public byte kenki;
