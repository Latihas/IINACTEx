...
public class Test : IScriptBase {
    ...
    public override List<StatusAdd> StatusAddList => [
        new(() => ScriptDrawList.Add(new IGCircle(Me_Position, 5, 5)), 171, TargetId: Me_HexID),
        new(() => ScriptDrawList.Add(new IGCone(Me_Position, 10, Me_Rotation(), 45, 5)), 171, TargetId: Me_HexID),
        new((_, _, t, _) => ScriptDrawList.Add(new IGLine(Me_Position, GetGameObjectById_Position(t), 10, 5)), 171, TargetId: Me_HexID)
    ];
}